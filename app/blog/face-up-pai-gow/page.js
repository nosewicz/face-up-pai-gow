    ...
    <>
      <main className="mx-auto my-10 max-w-4xl rounded-lg border border-slate-200 bg-white p-5 text-slate-950 shadow-xl md:p-8">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2">
          How Does Face-Up Pai Gow Differ?
        </h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2">
          Key Advantages of Face-Up Pai Gow
        </h2>
        <ul className="list-disc list-inside mb-4">
          ...
          <li>
            <strong>Faster Pace:</strong> Some versions skip certain pushes or
            are more streamlined with paying out winners.
          </li>
          <li>
            <strong>Practice Potential:</strong> Our free trainer helps you
            learn this variation without risking any real chips.
          </li>
        </ul>
        ...
        <p className="mb-4">
          The best way to excel at Face-Up Pai Gow is to <strong>practice</strong>. 
          Our trainer replicates real casino scenarios, letting you refine your
          approach before taking a seat at a live table.
        </p>
        ...
        <ul className="list-disc list-inside mb-4">
          ...
          <li>Don’t forget to look for ways to maximize the <em>Joker</em> usage.</li>
        </ul>

        <p className="mb-4">
          Ready to gain an edge? Jump into our <Link href="/" className="text-blue-600 hover:underline">free Face-Up Pai Gow trainer</Link> now and start honing your skills.
        </p>
      </main>
    </>
  );
